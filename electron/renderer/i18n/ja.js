...
export const ja = {
  ...
  auth: {
    ...
    password: "パスワード",
    signIn: "ログイン",
    keepSignedIn: "ログイン状態を保つ",
    sessionExpiredTitle: "VRChatのセッションが期限切れです",
    sessionExpiredBody: "ログアウトされました。自動化を再開するには再度ログインしてください。",
    keepSignedInHint: "ログイン情報を暗号化して保存し、セッションが切れてもバックグラウンドの自動化が自動的に再ログインできるようにします。",
