...
export const ko = {
  ...
  auth: {
    ...
    signIn: "로그인",
    keepSignedIn: "로그인 유지",
    sessionExpiredTitle: "VRChat 세션이 만료되었습니다",
    sessionExpiredBody: "로그아웃되었습니다. 자동화를 재개하려면 다시 로그인하세요.",
    keepSignedInHint: "로그인 정보를 암호화하여 저장하므로 세션이 만료되어도 백그라운드 자동화가 스스로 다시 로그인할 수 있습니다.",
  ...
  settings: {
    ...
    security: {
      ...
      unreadableTitle: "저장된 자격 증명을 이 컴퓨터에서 더 이상 읽을 수 없습니다",
      unreadableDetail: "VRChat 로그인 정보나 Discord 토큰이 이 컴퓨터의 보안 저장소로 암호화되었지만, 앱이 더 이상 복호화할 수 없습니다. 대개 그 저장소가 변경되었거나 초기화되었거나 잠겨 있기 때문입니다. 이에 의존하는 기능(자동 게시, Discord)은 다시 로그인하거나 설정에서 자격 증명을 다시 입력할 때까지 일시 중지됩니다."
    },
    general: {
      title: "일반",
  ...
  conflict: {
    ...
    changeTime: "시간 다시 선택",
    continue: "그대로 생성",
    unavailable: "이 시간에 다른 이벤트가 이미 예정되어 있는지 확인할 수 없습니다. VRChat에 연결하지 못했을 수 있습니다."
  },
  schedules: {
    announcements: {
