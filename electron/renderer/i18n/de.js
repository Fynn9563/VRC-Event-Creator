...
export const de = {
  ...
  auth: {
    ...
    sessionExpiredTitle: "VRChat-Sitzung abgelaufen",
    sessionExpiredBody: "Du wurdest abgemeldet. Melde dich erneut an, um die Automatisierung fortzusetzen.",
  ...
  settings: {
    ...
    security: {
      ...
      unreadableTitle: "Eine gespeicherte Anmeldeinformation kann auf diesem Computer nicht mehr gelesen werden",
      unreadableDetail: "Ihre VRChat-Anmeldung oder ein Discord-Token wurde mit dem sicheren Speicher dieses Computers verschlüsselt, und die App kann es nicht mehr entschlüsseln – meist weil dieser Speicher geändert, zurückgesetzt oder gesperrt wurde. Alles, was darauf angewiesen ist (automatisches Posten, Discord), ist pausiert, bis Sie sich erneut anmelden oder die Anmeldeinformation in den Einstellungen neu eingeben."
    },
    general: {
      title: "Allgemein",
