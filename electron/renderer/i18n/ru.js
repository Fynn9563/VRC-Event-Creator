...
export const ru = {
  ...
  auth: {
    ...
    sessionExpiredTitle: "Сессия VRChat истекла",
    sessionExpiredBody: "Вы вышли из системы. Войдите снова, чтобы возобновить автоматизацию.",
    keepSignedInHint: "Сохраняет ваши данные для входа (в зашифрованном виде), чтобы фоновая автоматизация могла сама войти снова, если ваша сессия истечёт.",
    reauthNotifyTitle: "Требуется вход в VRChat",
    reauthNotifyBody: "Ваша сессия истекла, и для возобновления автоматизации нужен код двухфакторной аутентификации. Откройте приложение, чтобы ввести его.",
    keepSignedInSettingsHint: "Выключите, чтобы удалить сохранённые данные для входа сейчас, не выходя из системы. Включение вступит в силу при следующем входе.",
    reloginFailedTitle: "Автоматический вход перестал работать",
    reloginFailedBody: "Приложению не удалось войти снова с сохранёнными данными (возможно, ваш пароль VRChat изменился). Пожалуйста, войдите снова, чтобы возобновить автоматизацию.",
    logout: "Выйти",
  ...
  settings: {
    ...
    security: {
      ...
      unreadableTitle: "Сохранённые учётные данные больше не читаются на этом компьютере",
      unreadableDetail: "Ваш вход в VRChat или токен Discord были зашифрованы защищённым хранилищем этого компьютера, и приложение больше не может их расшифровать — обычно потому, что это хранилище изменилось, было сброшено или заблокировано. Всё, что от них зависит (автоматическая публикация, Discord), приостановлено, пока вы не войдёте снова или не введёте учётные данные заново в настройках."
    },
    general: {
      title: "Общие",
