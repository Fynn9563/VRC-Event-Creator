...
export const en = {
  ...
  auth: {
    ...
    sessionExpiredTitle: "VRChat session expired",
    sessionExpiredBody: "You've been signed out. Sign in again to resume automation.",
    keepSignedInHint: "Stores your login (encrypted) so background automation can sign back in on its own if your session expires.",
