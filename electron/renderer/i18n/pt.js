...
export const pt = {
  ...
  auth: {
    ...
    sessionExpiredTitle: "Sessão do VRChat expirada",
    sessionExpiredBody: "Você foi desconectado. Entre novamente para retomar a automação.",
  ...
  modify: {
    ...
    pending: {
      ...
      postPastStart: "Este evento já começou, então não é possível publicá-lo.",
  ...
  conflict: {
    ...
    unavailable: "Não foi possível verificar se já há outro evento agendado neste horário. O VRChat pode estar indisponível."
  },
  schedules: {
    announcements: {
